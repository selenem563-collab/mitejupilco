    ...
    a(b).on("load", function () {
        ...
        (e.prototype = {
            ...
            _c2: function (b, c) {
                ...
                for (this.p = [], d = 0; d < k.length; d++)
                    c(a.inArray(k[d].iso2, b)) && this.p.push(k[d]);
            },
            _d: function () {
                this.b.onlyCountries.length
                    ? this._c2(this.b.onlyCountries, function (a) {
                          return a != -1;
                      })
                    : this.b.excludeCountries.length
                    ? this._c2(this.b.excludeCountries, function (a) {
                          return a == -1;
                      })
                    : (this.p = k);
            },
            ...
            _o: function () {
                ...
                if (
                    ...
                    var d = this.a.offset(),
                        ...
                        f = a(b).scrollTop(),
                        g =
                            e + this.a.outerHeight() + this.n <
                            f + a(b).height(),
                        h = e - this.n > f;
                    if (
                        (this.m.toggleClass("dropup", !g && h),
                        this.b.dropdownContainer)
                    ) {
            ...
            _s: function (a) {
                for (var b = 0; b < this.p.length; b++)
                    if (this._t(this.p[b].name, a)) {
                        var c = this.m
                            .children(
                                "[data-country-code=" + this.p[b].iso2 + "]"
                            )
                            .not(".preferred");
            ...
            _z: function (a) {
                ...
                if (
                    (this.l.parent().attr("title", c), this.b.separateDialCode)
                ) {
                    var d = this.s.dialCode ? "+" + this.s.dialCode : "",
                        e = this.a.parent();
                    b.dialCode &&
                        e.removeClass("iti-sdc-" + (b.dialCode.length + 1)),
            ...
            _ag: function () {
                var a,
                    ...
                    c = this.s.dialCode;
                return (
                    (a = this.b.separateDialCode
                        ? "+" + c
                        : c &&
                          "1" == c.charAt(0) &&
                          4 == c.length &&
                          c.substr(1) != b.substr(0, 3)
                        ? c.substr(1)
                        : ""),
                    a + b
                );
